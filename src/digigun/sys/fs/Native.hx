...
extern class Native {
    ...
    @:native("fs_file_lock")
    static function file_lock(path:String, exclusive:Int, wait:Int):haxe.Int64;
    ...
    @:native("fs_mmap_open")
    static function mmap_open(path:String, size:Int, writable:Int):haxe.Int64;
    ...
    @:native("fs_set_xattr")
    static function set_xattr(path:String, name:String, value:cpp.RawPointer<cpp.UInt8>, length:Int):Int;
